package datainsider.login_provider.module

import com.google.inject.name.Named
import com.google.inject.{Provides, Singleton}
import com.twitter.inject.TwitterModule
import datainsider.login_provider.repository.{OAuthConfigRepository, OAuthConfigRepositoryImpl}
import datainsider.login_provider.service.{OrgOAuthorizationProvider, OrgOAuthorizationProviderImpl}

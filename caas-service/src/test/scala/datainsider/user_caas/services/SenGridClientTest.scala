...
import datainsider.user_profile.controller.http.request.RegisterOrgRequest
...
class SenGridClientTest extends Test {
  test("send email with sendgrid") {
    ...
    val sg = new SendGrid("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")

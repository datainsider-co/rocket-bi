...
import co.datainsider.jobscheduler.domain.job.TikTokAdsEndPoint.TikTokAdsEndPoint
import co.datainsider.jobscheduler.domain.{JobProgress, TikTokAdsProgress}

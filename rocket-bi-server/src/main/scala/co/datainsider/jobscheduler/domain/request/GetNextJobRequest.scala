...
case class MultiDeleteJobRequest(ids: Array[Long], @Inject request: Request) extends LoggedInRequest

case class CreateJobFromTableNamesRequest(
    baseJob: Job,
    tableNames: Seq[String],
    @Inject request: Request
) extends LoggedInRequest

case class MultiCreateJobRequest(
    jobs: Seq[Job],
    @Inject request: Request
) extends LoggedInRequest

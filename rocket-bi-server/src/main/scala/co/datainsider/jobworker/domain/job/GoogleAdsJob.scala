...
import GoogleResource.GoogleResource
...
case class GoogleAdsJob(
    ...
    customerId: String,
    @JsonScalaEnumeration(classOf[GoogleResourceRef]) resourceName: GoogleResource,
...
class GoogleResourceRef extends TypeReference[GoogleResource.type]

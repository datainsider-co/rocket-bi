//package co.datainsider.caas.user_profile.controller.thrift
//
...
//  TUserInfoLike
//}
//import co.datainsider.caas.user_profile.domain.user.{LoginResponse, UserProfile}
...
//import co.datainsider.caas.user_profile.service.{AuthService, OrganizationService, UserProfileService}
...
//  }
//
//  handle(DeleteUser).withFn { request: Request[DeleteUser.Args] =>
//    Profiler(s"[Thrift] ${this.getClass.getSimpleName}::DeleteUser") {
//      val args = request.args
//      adminService
//        .delete(args.organizationId, args.username, args.transferToEmail)
//        .map(result => TBoolResult(0, data = Some(result)))
//        .rescue {
//          case ex: Throwable => {
//            error(s"DeleteUser::error ${ex.getMessage}")
//            Future.value(TBoolResult(-1, msg = Some(ex.getMessage)))
//          }
//        }
//        .map(_.toScroogeResponse())
//    }

...
import co.datainsider.datacook.domain.EtlJob.EnhanceImplicitResultSet
...
class MockTrashETLRepository extends TrashETLRepository {
...
class TrashETLRepositoryImpl(client: JdbcClient, dbName: String, tblName: String) extends TrashETLRepository {

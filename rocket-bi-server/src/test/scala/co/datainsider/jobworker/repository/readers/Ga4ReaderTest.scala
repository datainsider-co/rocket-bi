...
import co.datainsider.jobworker.domain.source.{Ga4Source, GoogleServiceAccountSource}
...
import co.datainsider.jobworker.repository.reader.factory.{Ga4ReaderFactory, Ga4ServiceAccountReaderFactory}
import co.datainsider.bi.util.ZConfig
import com.twitter.inject.Test
import co.datainsider.schema.domain.column.{DoubleColumn, StringColumn}
import org.scalatest.BeforeAndAfterAll

class Ga4ReaderTest extends Test with BeforeAndAfterAll {
  val batchSize = 20
  ...
  val ga4Source = Ga4Source(
    1L,
    1L,
    "123",
    creatorId = "", System.currentTimeMillis(),
    accessToken = "ya29.a0Aa4xrXMRy1nzl2gjQ4CdFgpySpF75dfN32Gf_pyjXKILdUEpGfoFKNy5mYyS1y1K2L8OUBmwupfy-dgQZ4Owrs5qbwgP8mKMg0553_wbZdrvOpepGEhb3XqXyQraP3onAK33EgozchtI4f8kkkYU4bAfl10ZaCgYKATASARASFQEjDvL9oauk1ia_MhaTnfTEVRdYuQ0163",
    refreshToken = "1//0emp7P5Y9x8JaCgYIARAAGA4SNwF-L9IrRexgUJj6_GFRbkY1GPrmFCqMzFeVxt4x15fYXA8c7FSx7tWVG_T5Z_DyPVmr0wJxud0"
  )
  ...
  val ga4SourceFactory = new Ga4ReaderFactory(clientId, clientSecret, batchSize)

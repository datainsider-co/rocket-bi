...
//
//class OrderTransactionWorkerTest extends ShopifyWorkerTest {
//
...
//    destTableName = "order_transaction_1",
//    destinations = Seq(DataDestination.Clickhouse),
//    tableName = ShopifyTable.OrderTransaction,
//    lastSyncedValue = ""
//  )
//
//  val job2 = ShopifyJob(
...
//    currentSyncStatus = JobStatus.Syncing,
//    destDatabaseName = dbName,
//    destTableName = "order_transaction_2",
//    destinations = Seq(DataDestination.Clickhouse),
//    tableName = ShopifyTable.OrderTransaction,
...
//  }
//
//  test("Incremental sync transaction test") {
//
//    val syncId = 12
...
//  }
//
//  test("Incremental sync transaction test from latest id") {
//
//    val syncId = 13
//    await(ssdbKVS.add(syncId, true).asTwitter)
//    val worker = new ShopifyWorker(source, schemaService, kvs = ssdbKVS)
...
//  }
//
//  test("Incremental sync transaction test from order_id 4776703262947") {
//
//    val syncId = 13
//    await(ssdbKVS.add(syncId, true).asTwitter)
//    val worker = new ShopifyWorker(source, schemaService, kvs = ssdbKVS)

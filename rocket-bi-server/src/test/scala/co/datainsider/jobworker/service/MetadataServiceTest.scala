...
//import co.datainsider.jobworker.domain.request.{SuggestColumnRequest, SuggestDatabaseRequest, SuggestTableRequest, SuggestTableSchemaRequest}
...
//import datainsider.client.module.{MockCaasClientModule, MockHadoopFileClientModule, MockLakeClientModule}
//
//class MetadataServiceTest extends IntegrationTest {
//  override protected def injector: Injector =
//    TestInjector(JobWorkerTestModule, TestContainerModule, MockSchemaClientModule, MockHadoopFileClientModule, MockLakeClientModule, MockCaasClientModule).newInstance()
//

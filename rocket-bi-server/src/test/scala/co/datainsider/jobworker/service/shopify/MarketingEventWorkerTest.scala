...
//
//class MarketingEventWorkerTest extends ShopifyWorkerTest {
//
...
//    destTableName = "event_table_test_1",
//    destinations = Seq(DataDestination.Clickhouse),
//    tableName = ShopifyTable.MarketingEvent,
//    lastSyncedValue = ""
//  )
//
//  val job2 = ShopifyJob(
...
//    currentSyncStatus = JobStatus.Syncing,
//    destDatabaseName = dbName,
//    destTableName = "event_table_test_2",
//    destinations = Seq(DataDestination.Clickhouse),
//    tableName = ShopifyTable.MarketingEvent,
//    lastSyncedValue = "186063552739"
//  )
...
//  }
//
//  test("Incremental sync marketing event") {
//
//    val syncId = 12
...
//  }
//
//  test("Incremental sync marketing event from latest id") {
//
//    val syncId = 13
//    await(ssdbKVS.add(syncId, true).asTwitter)
//    val worker = new ShopifyWorker(source, schemaService, kvs = ssdbKVS)
...
//  }
//
//  test("Incremental sync marketing event from 92050177655011") {
//
//    val syncId = 13
//    await(ssdbKVS.add(syncId, true).asTwitter)
//    val worker = new ShopifyWorker(source, schemaService, kvs = ssdbKVS)

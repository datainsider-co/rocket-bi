...
//
//class CustomerWorkerTest extends ShopifyWorkerTest {
//
...
//    tableName = ShopifyTable.Customer,
//    lastSyncedValue = ""
//  )
//
//  val job2 = ShopifyJob(
...
//  }
//
//  test("Incremental sync customer test") {
//
//    val syncId = 12
...
//  }
//
//  test("Incremental sync customer test from latest id") {
//
//    val syncId = 13
//    await(ssdbKVS.add(syncId, true).asTwitter)
//    val worker: ShopifyWorker = createWorker(source)
...
//  }
//
//  test("Incremental sync customer test from 6241305755875") {
//
//    val syncId = 13
//    await(ssdbKVS.add(syncId, true).asTwitter)
//    val worker: ShopifyWorker = createWorker(source)

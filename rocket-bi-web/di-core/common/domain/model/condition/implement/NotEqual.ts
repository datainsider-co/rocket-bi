...
export class NotEqual extends FieldRelatedCondition implements ValueCondition {
  className = ConditionType.NotEqual;
  value: string;
  ...
  static fromObject(obj: NotEqual): NotEqual {
    const field = Field.fromObject(obj.field);
    const value = obj.value;
    return new NotEqual(field, value, getScalarFunction(obj.scalarFunction));
  }
  ...
  toConditionData(groupId: number): ConditionData {
    ...
    return {
      ...
      subType: StringConditionTypes.notEqual,
      firstValue: void 0,
      secondValue: void 0,
      allValues: [],

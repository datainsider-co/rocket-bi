...
import { DIMap, Position, TabId, WidgetCommonData, WidgetExtraData, WidgetId, Widgets } from '@core/common/domain/model';
...
export class TabWidget extends Widget {
  ...
  static fromObject(obj: TabWidget): TabWidget {
    ...
    return new TabWidget(obj, tabs, obj.extraData);
  }

...
import { ChartOption, ConditionType, FilterRequest, DynamicFunction, HistogramChartOption, In, VizSettingType, WidgetId } from '@core/domain';
...
export class TabFilterQuerySetting extends QuerySetting<TabFilterOption> implements Filterable, DynamicFunction {

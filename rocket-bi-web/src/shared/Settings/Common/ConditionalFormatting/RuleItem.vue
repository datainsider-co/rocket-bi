...
import { Rule, RuleType } from '@core/domain';
import ConditionItem, { ConditionItemType } from '@/shared/Settings/Common/ConditionalFormatting/ConditionItem.vue';
import ColorPicker, { PickerType } from '@/shared/components/ColorPicker.vue';
import { RulePickerType } from '@/shared/Settings/Common/ConditionalFormatting/FormattingOptions';
import IconPicker from '@/shared/Settings/Common/ConditionalFormatting/IconPicker.vue';

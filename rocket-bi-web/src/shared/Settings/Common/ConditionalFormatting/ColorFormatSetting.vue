...
import { ApplyToType, ColorFormatting, ConditionalFormattingType, DefaultValueFormattingType, Field, FunctionType } from '@core/domain';
import { FormattingOptions, FunctionFormattingType } from '@/shared/Settings/Common/ConditionalFormatting/FormattingOptions';
import ColorScalePanel from '@/shared/Settings/Common/ConditionalFormatting/ColorScalePanel.vue';
...
import RulePanel from '@/shared/Settings/Common/ConditionalFormatting/RulePanel.vue';
import FormatBySettingBar from '@/shared/Settings/Common/ConditionalFormatting/FormatBySettingBar.vue';
...
<style lang="scss" src="./color-format-setting.style.scss"></style>

...
import { DynamicFilter, Field, FilterMode, TabControl, TabControlData } from '@core/common/domain/model';
...
export default class DynamicFilterPopover extends Vue {
  ...
  private get dashboardControls(): TabControlData[] {
    return this.tabControls.map(tabControl => tabControl.toTabControlData());
  }

...
import { DynamicFilter, TabControl } from '@core/common/domain/model';
...
import DynamicFilterPopover from '@/shared/components/filters/dynamic-filter-panel/DynamicFilterPopover.vue';
import { DynamicFilterPopoverData } from '@/shared/components/filters/dynamic-filter-panel/DynamicFilterPopover';
...
export default class DynamicFilterPanel extends Vue {
  ...
  private readonly tabControls!: TabControl[];
  @Prop()
  id!: string;

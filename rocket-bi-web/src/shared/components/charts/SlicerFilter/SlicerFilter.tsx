...
import { And, ChartInfo, Condition, DIException, InputControlQuerySetting, SlicerConfig, SlicerFilterOption, TableResponse } from '@core/domain';
import { WidgetRenderer } from '@chart/WidgetRenderer';
import { DefaultSlicerFilter } from '@chart/SlicerFilter/DefaultSlicerFilter';
import { DefaultFilterValue, SlicerRange } from '@/shared';
import NumberSlicer, { SlicerDisplay } from '@chart/SlicerFilter/NumberSlicer.vue';
...
@Component({ components: { NumberSlicer, DateInputFilter: DateSelectFilter } })
export default class SlicerFilter extends BaseWidget {
  ...
  private onSlicerFilterChanged?: (range: SlicerRange) => void;
  ...
  private handleFilterChanged(range: SlicerRange) {
    ...
    if (this.onSlicerFilterChanged && !this.isPreview) {
      this.onSlicerFilterChanged(range);

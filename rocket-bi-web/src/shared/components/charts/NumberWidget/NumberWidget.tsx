...
import { ChartInfo, CompareStyle, NumberChartOption, NumberOptionData, NumberQuerySetting, TrendIcon } from '@core/domain/Model';
...
import { CompareMode } from '@core/domain';
import { NumberRenderer } from '@chart/WidgetRenderer/NumberRender/NumberRenderer';
import { ComparisonNumberRenderer, WidgetRenderer } from '@chart/WidgetRenderer';
import { KPIRenderer } from '@chart/WidgetRenderer/NumberRender/KPIRenderer';
...
export default class NumberWidget extends BaseChartWidget<SeriesOneResponse, NumberChartOption, NumberQuerySetting> {
  ...
  @Ref()
  private readonly trendLineChartHolder!: ChartHolderController;

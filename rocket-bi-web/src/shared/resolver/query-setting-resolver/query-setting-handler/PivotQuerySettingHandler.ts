...
import { Id, PivotTableQuerySetting, QuerySetting, TableColumn } from '@core/common/domain';
import { ListUtils, QuerySettingUtils } from '@/utils';
import { getExtraData, QuerySettingHandler } from '@/shared/resolver';

export class PivotQuerySettingHandler implements QuerySettingHandler {
  ...
  toQuerySetting(configsAsMap: Map<ConfigType, FunctionData[]>, filterAsMap: Map<Id, ConditionData[]>): QuerySetting {
    ...
    return new PivotTableQuerySetting(columns, rows, values, conditions, sortings, {});
  }

...
import { DrilldownPieQueryChartSetting, Id, QuerySetting, TableColumn } from '@core/common/domain';
 ...
 */
export class DrilldownPieQuerySettingHandler implements QuerySettingHandler {
  toQuerySetting(configsAsMap: Map<ConfigType, FunctionData[]>, filterAsMap: Map<Id, ConditionData[]>): QuerySetting {
    ...
    return new DrilldownPieQueryChartSetting(legends, value, conditions, sortings);
  }

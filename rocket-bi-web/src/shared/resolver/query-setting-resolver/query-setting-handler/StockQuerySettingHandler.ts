...
import { Id, QuerySetting, SeriesQuerySetting, StockQuerySetting, TabFilterQuerySetting, TableColumn } from '@core/common/domain';
import { ListUtils, QuerySettingUtils } from '@/utils';
import { getExtraData, QuerySettingHandler } from '@/shared/resolver';

export class StockQuerySettingHandler implements QuerySettingHandler {
  toQuerySetting(configsAsMap: Map<ConfigType, FunctionData[]>, filterAsMap: Map<Id, ConditionData[]>): QuerySetting {
    ...
    // return new StockQuerySetting(values, legend, conditions, sortings);

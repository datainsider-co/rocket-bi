...
import { GroupedTableQuerySetting, Id, QuerySetting, TableColumn, TableQueryChartSetting } from '@core/common/domain';
import { ChartUtils, ListUtils, QuerySettingUtils } from '@/utils';
import { getExtraData, QuerySettingHandler } from '@/shared/resolver';

export class FlattenTableQuerySettingHandler implements QuerySettingHandler {
  toQuerySetting(configsAsMap: Map<ConfigType, FunctionData[]>, filterAsMap: Map<Id, ConditionData[]>): QuerySetting {
    ...
    return new TableQueryChartSetting(columns, conditions, sortings);
  }

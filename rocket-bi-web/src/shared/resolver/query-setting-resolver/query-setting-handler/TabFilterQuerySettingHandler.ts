...
import { Id, QuerySetting, TabFilterQuerySetting, TableColumn } from '@core/common/domain';
import { ListUtils, QuerySettingUtils } from '@/utils';
import { getExtraData, QuerySettingHandler } from '@/shared/resolver';

export class TabFilterQuerySettingHandler implements QuerySettingHandler {
  ...
  toQuerySetting(configsAsMap: Map<ConfigType, FunctionData[]>, filterAsMap: Map<Id, ConditionData[]>): QuerySetting {
    ...
    return new TabFilterQuerySetting(values, conditions, sortings);
  }
}

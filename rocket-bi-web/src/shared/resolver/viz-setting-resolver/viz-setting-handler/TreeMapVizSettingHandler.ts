...
import { TreeMapChartOption, ChartOption, ChartOptionData } from '@core/common/domain';
import { merge } from 'lodash';
import { VizSettingHandler } from '@/shared/resolver';

export class TreeMapVizSettingHandler implements VizSettingHandler {
  toVizSetting(chartType: ChartType, diSettingOptions: ChartOptionData): ChartOption | undefined {
    ...
    return new TreeMapChartOption(newObject);
  }
}

...
import { ETL_OPERATOR_TYPE, EtlOperator, JoinOperator, ManageFieldOperator, PivotTableOperator, SQLQueryOperator, TransformOperator } from '@core/DataCook';
...
export default class OperatorContextMenu extends ContextMenuMixin {

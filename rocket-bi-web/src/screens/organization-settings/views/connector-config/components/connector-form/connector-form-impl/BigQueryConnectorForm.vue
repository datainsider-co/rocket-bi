...
import { BigqueryConnector } from '@core/connector-config';
...
export default class BigQueryConnectorForm extends Vue {
  protected readonly locations = require('./locations.json');
  @PropSync('model')
  protected source!: BigqueryConnector;

  protected credentialsError = '';
  protected projectIdError = '';
  ...
  protected selectDefaultLocation(callback?: Function) {

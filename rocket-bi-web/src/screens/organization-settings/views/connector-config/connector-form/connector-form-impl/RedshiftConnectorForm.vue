...
import { MySqlConnector, PostgreSQLConnector, SSHConfig, RedshiftConnector } from '@core/connector-config';
...
export default class RedshiftConnectorForm extends Vue {
  @PropSync('model')
  ...
  private get databaseErrorMsg(): string {

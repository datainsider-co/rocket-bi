...
import { ClickhouseSource, VerticaSource } from '@core/clickhouse-config';
import { CustomCell, HeaderData } from '@/shared/models';
import { HtmlElementRenderUtils } from '@/utils';

export class VerticaHeaderHandler extends DataSourceHeaderHandler<VerticaSource> {
  buildHeader(source: VerticaSource): HeaderData[] {
    return [
      {
        key: 'host',
        label: 'Host',

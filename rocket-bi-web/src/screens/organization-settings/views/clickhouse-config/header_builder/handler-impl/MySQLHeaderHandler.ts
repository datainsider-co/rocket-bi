...
import { ClickhouseSource, MySQLSource } from '@core/clickhouse-config';
import { CustomCell, HeaderData } from '@/shared/models';
import { HtmlElementRenderUtils } from '@/utils';

export class MySQLHeaderHandler extends DataSourceHeaderHandler<MySQLSource> {
  buildHeader(source: MySQLSource): HeaderData[] {
    return [
      {
        key: 'host',
        label: 'Host',

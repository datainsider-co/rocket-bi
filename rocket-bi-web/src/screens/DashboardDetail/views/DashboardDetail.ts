import AddChartModal from '@/screens/DashboardDetail/components/AddChartModal.vue';
import BoostContextMenu from '@/screens/DashboardDetail/components/DashboardControlBar/BoostContextMenu.vue';
import SortModal from '@/screens/DashboardDetail/components/SortModal.vue';
import WidgetSettingModal from '@/screens/DashboardDetail/components/WidgetSettingModal.vue';
...
import DashboardCtrl from '@/screens/DashboardDetail/components/Dashboard/Dashboard.ts';
...
import { AdhocBuilderConfig, ControlBuilderConfig, DefaultChartBuilderConfig } from '@/screens/DashboardDetail/components/DataBuilderModal/ChartBuilderConfig';
    ...
    switch (newChartInfo.getChartInfoType()) {
      ...
      case ChartInfoType.dynamicFunction: {
        await DashboardControllerModule.replaceDynamicFunction({
          widget: newChartInfo,
          selected: ((newChartInfo.setting as any) as DynamicFunction).getDefaultFunctions(),
          apply: true
        });
        break;
      }
  ...
  async updateChart(chartInfo: ChartInfo) {
    ...
    switch (chartInfo.getChartInfoType()) {
      ...
      case ChartInfoType.dynamicFunction: {
        ...
        const updateDefaultColumns = ((chartInfo.setting as any) as DynamicFunction).getDefaultFunctions();
        if (!isEqual(defaultColumns, updateDefaultColumns)) {

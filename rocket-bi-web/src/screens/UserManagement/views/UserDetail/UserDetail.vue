...
import Contact from '@/screens/UserManagement/components/UserDetail/Contact.vue';
import { CheckboxGroupOption, GroupCheckboxOption, Routers, Status } from '@/shared';
import UserPrivilege from '@/screens/UserManagement/components/UserDetail/UserPrivilege.vue';
import UserDeletion from '@/screens/UserManagement/components/UserDetail/UserDeletion.vue';
...
import { UserDetailPanelType } from '@/screens/UserManagement/store/enum';
...
<style lang="scss" src="./user-detail.scss"></style>

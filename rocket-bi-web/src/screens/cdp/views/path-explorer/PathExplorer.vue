...
import ManagePathExplorer from '@/screens/cdp/components/manage-path-explorer/ManagePathExplorer.vue';
...
import { PathExplorerInfo } from '@/screens/cdp/components/manage-path-explorer/PathExplorerInfo';

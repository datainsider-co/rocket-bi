...
import {
  ...
  SubEventStepValue
} from '@/screens/CDP/components/ManagePathExplorer/PathExplorer.entity';
import DiagramPanel from '@/screens/DataCook/components/DiagramPanel/DiagramPanel.vue';
import EventConnection from './DiagramPanelItem/EventConnection.vue';
...
import { NumberFormatter } from '@core/services';

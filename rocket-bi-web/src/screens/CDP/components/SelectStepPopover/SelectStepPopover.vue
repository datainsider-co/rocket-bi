...
import SelectionPopover from '@/screens/CDP/components/SelectStepPopover/SelectionPopover.vue';
...
import { CdpCohortLoader, CdpEventLoader, CdpSelectionLoader } from '@/screens/CDP/components/SelectStepPopover/CdpSelectionLoader';

...
import { DateCell, IconActionCell, UserAvatarCell } from '@/shared/components/Common/DiTable/CustomCell';
...
import ManageCohortCtrl from '@/screens/CDP/components/ManageCohort/ManageCohort.ctrl';
...
import { CohortActionName } from '@/screens/CDP/components/CohortFilter/CohortFilter.entity';
...
export default class CohortManagement extends Vue {
  ...
  @Ref()
  private manageCohort!: ManageCohortCtrl;

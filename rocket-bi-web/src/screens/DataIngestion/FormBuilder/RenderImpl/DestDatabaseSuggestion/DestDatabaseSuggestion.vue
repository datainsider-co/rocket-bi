...
<script>
import { Database } from '@/screens/DataIngestion/components/DiUploadDocument/entities/DocumentSchema';
...
import { DatabaseInfo } from '@core/domain';
...
export default Vue.extend({
  ...
  methods: {
    ...
    setTableName(name) {
      ...
      const tableExisted = this.table.items.find(tbl => tbl.displayName === name || tbl.id === name) !== undefined;
      if (tableExisted) {

...
<script lang="ts">
import BigQuerySyncModeConfig from '@/screens/DataIngestion/components/BigQuerySyncModeConfig.vue';
import GenericJdbcSyncModeConfig from '@/screens/DataIngestion/components/GenericJdbcJobForm/GenericJdbcSyncModeConfig.vue';
import JdbcSyncModeConfig from '@/screens/DataIngestion/components/JdbcSyncModeConfig.vue';
import ShopifySyncModeConfig from '@/screens/DataIngestion/components/ShopifySyncModeConfig.vue';
import MongoSyncModeConfig from '@/screens/DataIngestion/MongoJobForm/MongoSyncModeConfig.vue';

...
import Editor from '@/screens/lake-house/components/query-builder/Editor.vue';
...
import SQLLakeJobConfigModal from '@/screens/lake-house/views/job/config-modals/SQLLakeJobConfigModal.vue';
// @ts-ignore

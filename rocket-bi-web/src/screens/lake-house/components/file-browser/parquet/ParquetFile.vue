...
import { FileBrowserService, ParquetTableResponse } from '@core/lake-house';
import { ContextMenuItem, DefaultPaging } from '@/shared';
import ParquetTable from '@/screens/lake-house/components/file-browser/parquet/ParquetTable.vue';

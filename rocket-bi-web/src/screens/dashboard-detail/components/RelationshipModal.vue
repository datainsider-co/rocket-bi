...
import { DashboardModeModule, DashboardModule } from '@/screens/dashboard-detail/stores';
import { DashboardRelationshipHandler } from '@/screens/dashboard-detail/components/relationship/relationship-handler/DashboardRelationshipHandler';

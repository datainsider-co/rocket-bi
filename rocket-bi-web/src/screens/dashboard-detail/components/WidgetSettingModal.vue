...
import { FilterPanel, Widget, Widgets } from '@core/common/domain';
...
import DynamicConditionSetting from '@/screens/dashboard-detail/components/widget-setting/DynamicConditionSetting.vue';
...
export default class WidgetSettingModal extends Vue {
  ...
  private get isFilterPanel(): boolean {
    return FilterPanel.isFilterPanel(this.widget);
  }

...
import ActionMore from '@/screens/dashboard-detail/components/widget-container/other/ActionMore.vue';
import { DashboardEvents } from '@/screens/dashboard-detail/enums/DashboardEvents';
import { PopupUtils } from '@/utils/PopupUtils';
import Swal from 'sweetalert2';
import TabControlViewer from '@/screens/dashboard-detail/components/widget-container/other/control-view/TabControlViewer.vue';
import InputControlViewer from '@/screens/dashboard-detail/components/widget-container/other/control-view/InputControlViewer.vue';

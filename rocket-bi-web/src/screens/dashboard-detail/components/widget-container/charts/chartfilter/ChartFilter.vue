...
import { ChartInfo, FilterRequest, In, QuerySetting, TabFilterOption, TableResponse, WidgetId } from '@core/common/domain';
...
import ChartFilterPopover from '@/screens/dashboard-detail/components/widget-container/charts/chartfilter/ChartFilterPopover.vue';
...
export default class ChartFilter extends Vue {
  ...
  private get response(): TableResponse {
    return ChartDataModule.chartDataResponses[this.metaData.chartFilter!.id] as TableResponse;
  }

...
import { ClickhouseDestinationConfig, DestinationConfig, KafkaStreamingJob, StreamingJobService } from '@core/data-ingestion';
...
import SelectDatabaseAndTableCtrl from '@/screens/data-cook/components/select-database-and-table/SelectDatabaseAndTable';
import { StringColumn, TableSchema } from '@core/common/domain';

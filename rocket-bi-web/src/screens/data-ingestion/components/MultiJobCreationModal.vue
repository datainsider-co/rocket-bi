...
import MultiMongoFromDatabaseSuggestion from '@/screens/data-ingestion/mongo-job-form/MultiMongoFromDatabaseSuggestion.vue';
...
import MultiGenericJdbcFromDatabaseSuggestion from '@/screens/data-ingestion/components/generic-jdbc-job-form/MultiGenericJdbcFromDatabaseSuggestion.vue';
...
export default class MultiJobCreationModal extends Vue {
  ...
  private async handleSelectPalexy(source: DataSourceInfo) {

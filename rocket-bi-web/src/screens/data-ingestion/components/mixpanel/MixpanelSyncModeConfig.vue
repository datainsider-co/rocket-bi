<template>
  <div class="mixpanel-sync-mode-config job-section">
...
import { MixpanelJob, PalexyDateRange, PalexyJob, PalexyTime, SyncMode } from '@core/data-ingestion';
...
export default class MixpanelSyncModeConfig extends Vue {

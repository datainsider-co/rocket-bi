...
import { FacebookAdsSourceInfo, TiktokSourceInfo } from '@core/data-ingestion';
import { StringUtils } from '@/utils';
import { DIException } from '@core/common/domain';

export class TiktokSourceFormRender implements DataSourceFormRender {
  private sourceInfo: TiktokSourceInfo;
  private onSubmit: (() => void) | null;

  constructor(sourceInfo: TiktokSourceInfo, onSubmit?: () => void) {
  ...
  createDataSourceInfo(): DataSourceInfo {
    return TiktokSourceInfo.fromObject(this.sourceInfo);
  }

  validSource(source: TiktokSourceInfo) {

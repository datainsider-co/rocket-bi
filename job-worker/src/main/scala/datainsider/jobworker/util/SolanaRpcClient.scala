package io.chaininsider.service

import com.fasterxml.jackson.databind.JsonNode
import datainsider.jobworker.util.JsonUtils
import io.chaininsider.domain.Commitment.Commitment
import io.chaininsider.domain.{BlockOption, ClusterNode, CommitmentOption}

...
import datainsider.jobworker.domain.Ids.{JobId, SyncId}
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[FacebookAdsProcess], name = "facebook_ads_progress"),
...
case class FBProgress(
  ...
  override def progressData: Map[String, Any] = Map.empty

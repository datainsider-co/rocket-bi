...
class BlogWorkerTest extends ShopifyWorkerTest {
  ...
  test("Incremental sync blog  from latest id") {
  ...
  test("Incremental sync blog  from 87188668643") {

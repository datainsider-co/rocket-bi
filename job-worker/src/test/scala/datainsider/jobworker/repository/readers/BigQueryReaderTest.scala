...
//
//class BigQueryReaderTest extends FunSuite {
//
//  val serviceKey =
//    """{
...
//      |""".stripMargin
//
//  val dbName = "bigquery-public-data.usa_names"
//  val tblName = "usa_1910_current"
//
...
//  )
//
//  val reader: JdbcReader = JdbcReader(source, job, 3)
//
...
//    val incrementalJob = job.copy(incrementalColumn = Some("year"), lastSyncedValue = "2020")
//
...
//      count += records.length
//      records.foreach(row => println(row.mkString(", ")))
//      println("last sync value: " + reader.getLastSyncedValue)
//    }
//    println("count: " + count)
//
//  }

...
import datainsider.client.domain.schema.column.{Column, DateTimeColumn}
import datainsider.jobworker.client.JdbcClient.Record
import datainsider.jobworker.repository.reader.{IncrementalMongoReader, MongoReader, SimpleMongoReader}
...
class MongoReaderTest extends FunSuite with BeforeAndAfterAll {
  ...
  val uri = s"mongodb+srv://$username:$encoded_pwd@$host"

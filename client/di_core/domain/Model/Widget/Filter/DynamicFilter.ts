...
import { Condition, Field, FieldRelatedCondition, InlineSqlView, TabControlData, WidgetExtraData, WidgetId, Widgets } from '@core/domain/Model';
...
import { FilterWidget } from '@core/domain';
import { FieldDetailInfo } from '@core/domain/Model/Function/FieldDetailInfo';
import { TableField } from '@core/domain';

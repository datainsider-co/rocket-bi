import { CSVFileConfig, DataDestination, DataSourceInfo, Job, JobStatus, JobType, SyncMode } from '@core/DataIngestion';
import { FileConfig } from '@core/DataIngestion/Domain/Job/FileConfig';
import { JobName } from '@core/DataIngestion/Domain/Job/JobName';
import { JobId, SourceId, TableSchema } from '@core/domain';

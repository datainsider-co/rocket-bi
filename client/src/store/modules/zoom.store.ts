...
import { ChartInfo, QueryRelatedWidget, ScalarFunctionType, WidgetId, Zoomable } from '@core/domain/Model';
  ...
  loadZoomLevels(widgets: QueryRelatedWidget[]) {
    const zoomNodes = [
      [
        ...
        new ZoomLevelNode(ScalarFunctionType.ToDayOfMonth, DateFunctionTypes.dayOfWeek),

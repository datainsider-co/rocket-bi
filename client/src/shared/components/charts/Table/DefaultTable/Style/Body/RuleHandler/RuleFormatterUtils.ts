...
import { ColorFormatting, IconFormatting, MinMaxData } from '@core/domain';
import { HeaderData } from '@/shared/models';
import { RuleResolver } from '@chart/Table/DefaultTable/Style/Body/RuleHandler/RuleResolver';

...
import ColorFormatSetting from '@/shared/Settings/Common/ConditionalFormatting/ColorFormatSetting.vue';
...
import DataBarSetting from '@/shared/Settings/Common/ConditionalFormatting/DataBarSetting.vue';
import IconFormatSetting from '@/shared/Settings/Common/ConditionalFormatting/IconFormatSetting.vue';
import {
  SettingKey,
  DataBarFormatting,
  IconFormatting,

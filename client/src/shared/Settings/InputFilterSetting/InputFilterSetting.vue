...
import { ChartInfo, GroupedTableQuerySetting, InputFilterOption, SettingKey } from '@core/domain';
...
import InputFilterControlTab from '@/shared/Settings/InputFilterSetting/InputFilterControlTab.vue';

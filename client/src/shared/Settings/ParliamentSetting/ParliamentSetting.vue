...
import { ChartInfo, ParliamentQuerySetting, ParliamentChartOption, SettingKey } from '@core/domain';
...
import ParliamentLayoutTab from '@/shared/Settings/ParliamentSetting/PaliarmentLayoutTab.vue';

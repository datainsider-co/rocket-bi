...
import { ChartInfo, GroupedTableQuerySetting, SettingKey, SlicerFilterOption } from '@core/domain';
...
import DateTabControl from '@/shared/Settings/DateFilterSetting/DateTabControl.vue';

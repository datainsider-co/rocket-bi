...
import { ChartInfo, GroupMeasurementQuerySetting, SettingKey, TabFilterOption } from '@core/domain';
...
import DynamicFunctionControlTab from '@/shared/Settings/TabFilterSetting/DynamicFunctionControlTab.vue';

...
export class GoogleAnalyticsJobFormRender implements JobFormRender {
  ...
  private allMetrics = require(`@/screens/DataIngestion/constants/metrics.json`);

  private allDimensions = require(`@/screens/DataIngestion/constants/dimensions.json`);

  private gaCubes: Record<string, Record<string, number>> = require(`@/screens/DataIngestion/constants/ga_cubes.json`);

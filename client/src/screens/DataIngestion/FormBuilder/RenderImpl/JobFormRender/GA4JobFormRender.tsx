...
import DatePickerInput from '@/screens/DataIngestion/FormBuilder/RenderImpl/DatePickerInput.vue';
...
export class GA4JobFormRender implements JobFormRender {
  ...
  private accountSummaries: gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaAccountSummary[] = [];
  private selectedAccountSummarize: gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaAccountSummary | null = null;
  private account = '';
  private property = '';
  ...
  private googleConfig = require('@/screens/DataIngestion/constants/GoogleConfig.json');
  ...
  private updateAccountSummarize(accountSummary: gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaAccountSummary) {
  ...
  private updatePropertySummarize(propertySummary: gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaPropertySummary) {
  ...
  private async handleSelectAccountSummarize(item: gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaAccountSummary) {
    this.updateAccountSummarize(item);
  }

  private async handlePropertySelected(item: gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaPropertySummary) {
    try {
              ...
              <div class="analytics-job-row-item">
                ...
                <div class="input">
                  <DiDropdown
                    ...
                    onSelected={(item: gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaAccountSummary) => this.handleSelectAccountSummarize(item)}
              ...
              <div class="analytics-job-row-item">
                ...
                <div class="input">
                  <DiDropdown
                    ...
                    valueProps="property"
                    label-props="displayName"
                    onSelected={(item: gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaPropertySummary) => this.handlePropertySelected(item)}
                    value={this.property}>
                    <template slot="icon-dropdown">
                      {this.isPropertyLoading ? (
                        <i alt="dropdown" class="fa fa-spin fa-spinner text-muted"></i>

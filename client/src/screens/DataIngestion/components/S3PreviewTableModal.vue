          ...
          <div class="col-12 col-sm-5 col-lg-4 text-left" v-if="job">
            <div class="form-group form-group-di">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <i class="ml-auto">
                  <img src="../components/DiUploadDocument/assets/icons/question.svg" alt="" width="16" height="16" />
                </i>
              </div>
...
import { PreviewResponse, S3Job, S3SourceInfo } from '@core/DataIngestion';
import { Column, ColumnType } from '@core/domain';

  ...
  <LayoutContent>
    ...
    <div class="token-management" ref="container">
      <div class="token-management-header d-flex align-items-center">
        ...
        <div v-if="!(isEmptySearchKeyword && isEmptyToken)" class="d-flex align-items-center ml-auto">
          <DiSearchInput class=" mr-3" border v-model="searchKeyword" placeholder="Search API key name..." />
...
import APIKeyConfigModal from '@/screens/OrganizationSettings/views/TokenManagement/APIKeyConfigModal.vue';

...
import VisualizationItemListing from './ChartSelectionPanel/VisualizationItemListing.vue';
...
export default class ConfigBuilderCtrl extends Vue {
  ...
  @Track(TrackEvents.SelectChartType, { chart_type: (_: ConfigBuilderCtrl, args: any) => args[0].type })

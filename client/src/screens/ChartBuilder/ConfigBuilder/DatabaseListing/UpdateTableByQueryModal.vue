...
import { DatabaseSchema, DIException, Field, TableSchema } from '@core/domain';
...
import { DatabaseTreeViewMode } from '@/screens/DataManagement/components/DatabaseTreeView/DatabaseTreeView.ctrl';
import { PopupUtils } from '@/utils/popup.utils';
import { Track } from '@/shared/anotation';
import { TrackEvents } from '@core/tracking/enum/TrackEvents';
import { ListUtils } from '@/utils';

const QueryComponent = () => import('@/screens/DataManagement/components/QueryComponent.vue');
...
<style lang="scss" scoped src="@/screens/ChartBuilder/DataCook/query-builder.scss"></style>
<style lang="scss">

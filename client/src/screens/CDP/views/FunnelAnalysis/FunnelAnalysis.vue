...
import ManageFunnelAnalysis from '@/screens/CDP/components/ManageFunnelAnalysis/ManageFunnelAnalysis.vue';
import { FunnelAnalysisInfo } from '@/screens/CDP/components/ManageFunnelAnalysis/FunnelAnalysis.entity';

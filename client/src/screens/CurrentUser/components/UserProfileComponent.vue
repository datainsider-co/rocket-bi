...
import { Gender, UserGenders, UserProfile } from '@core/domain';
import { Inject } from 'typescript-ioc';
import { Log } from '@core/utils';
import StatusWidget from '@/shared/components/StatusWidget.vue';
import UserProfileEditingModal from '@/screens/CurrentUser/components/UserProfileEditingModal.vue';
import { HtmlElementRenderUtils } from '@/utils/HtmlElementRenderUtils';
import PropertyListing, { PropertyListingItem } from '@/screens/CurrentUser/components/PropertyListing.vue';
...
@Component({
  components: { PropertyListing, UserProfileEditingModal, StatusWidget, RightPanel, LayoutContent, LayoutHeader }
})
export default class UserProfileComponent extends Vue {
  private readonly verticalScrollConfig = VerticalScrollConfigs;
  private userProfile: UserProfile | null = null;
  private readonly dataManager: DataManager = DI.get(DataManager);

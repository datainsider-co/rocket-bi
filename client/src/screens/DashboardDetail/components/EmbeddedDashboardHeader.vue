...
import { DashboardModule, FilterModule, WidgetModule } from '@/screens/DashboardDetail/stores';
...
import EmbeddedDashboardControlBar from '@/screens/DashboardDetail/components/DashboardControlBar/EmbeddedDashboardControlBar.vue';

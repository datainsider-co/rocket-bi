...
import { Condition, DynamicFunctionWidget, FilterRequest } from '@core/domain';
...
import { DynamicControlData } from '@/screens/DashboardDetail/intefaces/DynamicControlData';

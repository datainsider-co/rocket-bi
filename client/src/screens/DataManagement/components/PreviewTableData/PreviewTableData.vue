...
import { ChartInfo, QuerySetting, RawQuerySetting, TableChartOption, TableSchema, WidgetCommonData } from '@core/domain';
...
import { _ChartStore, DashboardControllerModule, QuerySettingModule } from '@/screens/DashboardDetail/stores';

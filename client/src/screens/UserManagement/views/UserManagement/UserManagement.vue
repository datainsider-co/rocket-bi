...
import UserManagementHeader from '@/screens/UserManagement/components/UserManagement/UserManagementHeader.vue';
...
<style lang="scss" src="./user-management.scss"></style>

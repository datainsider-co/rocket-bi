CREATE DATABASE IF NOT EXISTS `caas`;
...
CREATE TABLE IF NOT EXISTS `caas`.`user`
(
...
CREATE TABLE IF NOT EXISTS `caas`.`organization`
(
...
CREATE TABLE IF NOT EXISTS `caas`.`organization_members`
(
    `organization_id` bigint(20) NOT NULL,
    `username`        varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `caas`.`role`
(
    `organization_id` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `caas`.`role_permissions`
(
    `organization_id` bigint(20) NOT NULL,
    `role_id`         int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `caas`.`user_permissions`
(
    `organization_id` bigint(20) NOT NULL,
    `username`        varchar(255) NOT NULL,
    `permission`      varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `caas`.`user_roles`
(
    `username`        varchar(255) NOT NULL,
    `organization_id` bigint(20) NOT NULL,
    `role_id`         int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `caas`.`user_profile`(
    `organization_id` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `caas`.`login_method_provider`
(
...
CREATE TABLE IF NOT EXISTS `caas`.`api_key`
(
    `organization_id` bigint(20) NOT NULL,
...
INSERT IGNORE INTO `caas`.`user` (organization_id, username, password, is_active, created_time)
...
INSERT IGNORE INTO `caas`.`organization` (organization_id, name, owner, domain, is_active, report_time_zone_id, thumbnail_url, created_time, updated_time, updated_by, licence_key)
...
INSERT IGNORE INTO `caas`.`user_permissions` (organization_id, username, permission)
VALUES(0, 'root', '0:*:*:*'), (0, 'root', '0:view_data'), (0, 'root', '0:edit_data');

--- add root user profile;
INSERT IGNORE INTO `caas`.`user_profile`(organization_id, username, full_name, email, created_time, updated_time)
VALUES(0, 'root', 'root', 'hello@gmail.com', unix_timestamp(now()) * 1000, unix_timestamp(now()) * 1000);

--- insert supported login methods;
INSERT IGNORE INTO `caas`.`login_method_provider` (oauth_type, organization_id, oauth_config)
VALUES  ('gg', 0, '{"is_active":false,"whitelist_email":[],"client_ids":["147123631762-p2149desosmqr59un7mbjm2p65k566gh.apps.googleusercontent.com"],"organization_id":0,"oauth_type":"gg","name":"Google"}');

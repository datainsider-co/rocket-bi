...
import co.datainsider.caas.login_provider.domain._
...
object OAuthProvider {
  ...
  def generatePassword(id: String) =
    HmacUtils.hmacSha1Hex(id + OAuthProvider.PassSecretKey, OAuthProvider.PassSecretKey)

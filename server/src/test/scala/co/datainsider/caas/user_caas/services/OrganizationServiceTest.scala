...
import co.datainsider.caas.user_profile.controller.http.request.CreateOrganizationRequest
...
//  test("Send verify code") {
////    val result = organizationService.sendVerifyCode("
//    val email = "duc@datainsider.co"
//    val result: Boolean = organizationService.sendVerifyCode(email).syncGet()

...
import co.datainsider.bi.module.{CommonModule, TestBIClientModule, TestCommonModule, TestContainerModule, TestModule}
...
class ClickhouseMetaDataHandlerTest extends IntegrationTest {
  ...
  val executor: DDLExecutor = clickhouseEngine.getDDLExecutor()
  val client: JdbcClient = clickhouseEngine.client

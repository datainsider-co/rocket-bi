...
class BigQueryDDLExecutorTest extends Test {
  ...
  val bigqueryEngine = bigqueryEngineCreator.create(bigquerySource)
  ...
  val bigquery: BigQuery = bigqueryEngine.client.bigquery
  val ddlExecutor = bigqueryEngine.getDDLExecutor()
  private val orgId = 1

...
import co.datainsider.common.client.domain.scheduler.ScheduleOnce
    ...
    val ok = repository
      .update(
        ...
        dashboard = Dashboard(
          ...
          creatorId = "root",
          ownerId = "root",
          mainDateFilter = Some(MainDateFilter(TableField("db", "table", "name", "string"), MainDateFilterMode.LastMonth)),
          setting = Some(Serializer.fromJson[Map[String, JsonNode]]("{}")),

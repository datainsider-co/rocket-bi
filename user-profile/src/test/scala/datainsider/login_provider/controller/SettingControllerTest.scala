package datainsider.login_provider.controller

import com.twitter.finatra.http.EmbeddedHttpServer
import com.twitter.inject.server.FeatureTest
import datainsider.client.domain.user.LoginResult
import datainsider.login_provider.domain.{GoogleOAuthConfig, OAuthConfig, OAuthType}
import datainsider.user_profile.{Server, TestServer}
import datainsider.user_profile.controller.http.filter.parser.LoginOAuthRequest
import datainsider.user_profile.controller.http.request.LoginByEmailPassRequest

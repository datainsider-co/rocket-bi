...
import { ChartInfo, SettingKey, SankeyChartOption, SankeyQuerySetting } from '@core/domain';
...
import SankeyDataLabelTab from '@/shared/Settings/SankeySetting/SankeyDataLabelTab.vue';

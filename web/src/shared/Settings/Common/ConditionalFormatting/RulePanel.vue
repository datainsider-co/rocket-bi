...
import { Rule, RuleType, ValueType } from '@core/domain';
import { cloneDeep } from 'lodash';
import { ListUtils, RandomUtils } from '@/utils';
import RuleItem from '@/shared/Settings/Common/ConditionalFormatting/RuleItem.vue';
import { RuleUtils } from '@/shared/Settings/Common/ConditionalFormatting/RuleUtils';

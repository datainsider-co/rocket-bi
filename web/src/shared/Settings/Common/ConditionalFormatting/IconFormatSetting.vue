...
import { ApplyToType, ConditionalFormattingType, Field, FunctionType, IconAlign, IconFormatting, IconLayout, IconStyle } from '@core/domain';
...
<style lang="scss" src="./icon-format-setting.style.scss"></style>

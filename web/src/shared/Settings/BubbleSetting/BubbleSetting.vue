...
import { BubbleQuerySetting, BubbleChartOption, ChartInfo, SettingKey } from '@core/domain';
...
export default class BubbleSetting extends Vue {
  ...
  private get query(): BubbleQuerySetting {
    return this.chartInfo.setting as BubbleQuerySetting;
  }

  private get setting(): BubbleChartOption {
    return this.chartInfo.setting.getChartOption() as BubbleChartOption;
  }

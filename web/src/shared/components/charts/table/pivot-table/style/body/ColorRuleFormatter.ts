...
import { ColorRuleFormatter as TableColorRuleFormatter } from '@chart/table/default-table/style/body/ColorRuleFormatter';

export class ColorRuleFormatter implements BodyStyleFormatter<PivotTableQuerySetting, AbstractTableResponse, PivotTableChartOption> {
  ...
  private canUseColorRule(bodyData: BodyData<PivotTableQuerySetting, AbstractTableResponse, PivotTableChartOption>) {

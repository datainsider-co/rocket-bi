...
@ClassProfiler({ prefix: 'DonutChart' })
export default class DonutChart extends BaseHighChartWidget<SeriesTwoResponse, DonutChartOption, PieQuerySetting> {
  @Ref()
  chart: any;
  ...
  protected buildHighchart() {
    try {
      ...
      if (e instanceof DIException) {
        ...
        Log.error(`HighchartsDonutChart:: buildChart:: ${e}`);

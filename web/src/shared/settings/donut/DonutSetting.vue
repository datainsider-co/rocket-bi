...
import { ChartInfo, ChartOption, DonutChartOption, PieQuerySetting, SettingKey } from '@core/common/domain';
...
export default class DonutSetting extends Vue {
  @Prop({ required: true })
  private readonly chartInfo!: ChartInfo;

  private readonly widgetType = ChartType.Donut;

  private get query(): PieQuerySetting {
    return this.chartInfo.setting as PieQuerySetting;
  }

  private get setting(): DonutChartOption {
    return this.chartInfo.setting.getChartOption() as DonutChartOption;
  }

...
import { ChartInfo, ChartOption, GenericChartQuerySetting, PieChartOption, PieQuerySetting, SettingKey, VariablepieChartOption } from '@core/common/domain';
...
export default class VariablepieSetting extends Vue {
  @Prop({ required: true })
  private readonly chartInfo!: ChartInfo;

  private readonly widgetType = ChartType.Variablepie;

  private get query(): GenericChartQuerySetting {
    return this.chartInfo.setting as GenericChartQuerySetting;
  }

  private get setting(): VariablepieChartOption {
    return this.chartInfo.setting.getChartOption() as VariablepieChartOption;
  }

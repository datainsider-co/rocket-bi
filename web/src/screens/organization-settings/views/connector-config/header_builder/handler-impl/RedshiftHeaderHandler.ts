...
import { ClickhouseConnector, MySqlConnector, RedshiftConnector } from '@core/connector-config';
import { CustomCell, HeaderData } from '@/shared/models';
import { HtmlElementRenderUtils } from '@/utils';

export class RedshiftHeaderHandler extends DataSourceHeaderHandler<RedshiftConnector> {
  buildHeader(source: RedshiftConnector): HeaderData[] {
    return [
      {
        key: 'host',
        label: 'Host',

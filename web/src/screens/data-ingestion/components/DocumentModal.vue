...
const JsDocument = () => import('@/screens/data-ingestion/components/analytic-document/JsDocument.vue');
const AndroidDocument = () => import('@/screens/data-ingestion/components/analytic-document/AndroidDocument.vue');
const IOSDocument = () => import('@/screens/data-ingestion/components/analytic-document/IOSDocument.vue');
const ReactNativeDocument = () => import('@/screens/data-ingestion/components/analytic-document/ReactNativeDocument.vue');
const FlutterDocument = () => import('@/screens/data-ingestion/components/analytic-document/FlutterDocument.vue');

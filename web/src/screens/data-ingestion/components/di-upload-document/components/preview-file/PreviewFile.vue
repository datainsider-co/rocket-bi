    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-5 col-lg-4 text-left">
        ...
        <div class="form-group form-group-di">
          ...
          <div class="d-flex align-items-center mb-3">
            <label class="di-radio">
              <input v-model="value.setting.add_batch_info" :value="true" @change="calcPreviewData(false)" type="radio" name="Metadata" />
              <span></span>
          ...
          <div class="d-flex align-items-center">
            <label class="di-radio">
              <input v-model="value.setting.add_batch_info" :value="false" @change="calcPreviewData(false)" type="radio" name="Metadata" />
              <span></span>
        ...
        <div class="form-group form-group-di">
          ...
          <div class="d-flex">
            <div class="dropdown encoding-dropdown">
              <a href="#" class="btn btn-di-default w-auto dropdown-toggle" data-toggle="dropdown">
...
<script src="./PreviewFile.js"></script>
<style lang="scss">
.delimiter-dropdown .btn {
  width: 90px !important;
  background: var(--input-background-color);
}
.encoding-dropdown .btn {

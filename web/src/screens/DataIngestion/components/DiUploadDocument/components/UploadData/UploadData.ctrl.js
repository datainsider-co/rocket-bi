...
import { DatabaseSchema } from '@core/domain';
...
export default {
  ...
  methods: {
    ...
    async onUploadComplete() {
      const databaseSchema = await DatabaseSchemaModule.handleGetDatabaseSchema(this.value.schema.db_name);
      DatabaseSchemaModule.setDatabaseSchema(databaseSchema);
    },
    reUpload() {
      // this.value.chunkContainer.reset();
      this.startUpload();

...
<script lang="ts">
import MultiJobCreationModal from '@/screens/DataIngestion/components/MultiJobCreationModal.vue';
import S3PreviewTableModal from '@/screens/DataIngestion/components/S3PreviewTableModal.vue';
...
import { DataSourceType, FormMode, JdbcJob, JobStatus, JobType, S3Job, S3SourceInfo, SortRequest, SyncMode } from '@core/DataIngestion';
...
import JobCreationModal from '@/screens/DataIngestion/components/JobCreationModal.vue';
import { StatusCell } from '@/shared/components/Common/DiTable/CustomCell/StatusCell';
import { JobActionCell } from '@/screens/DataIngestion/components/JobActionCell';

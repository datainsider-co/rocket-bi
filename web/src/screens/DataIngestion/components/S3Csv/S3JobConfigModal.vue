...
import S3DataSourceConfig from '@/screens/DataIngestion/components/S3Csv/S3DataSourceConfig.vue';
...
import { DataDestination, FormMode, Job, S3Job, S3SourceInfo, SyncMode } from '@core/DataIngestion';

...
import { MapItem } from '@core/common/domain/response';
...
import { ChartInfo, MapChartChartOption } from '@core/common/domain';
...
@import '../../../shared/components/charts/custom-table/Table';
//.matching-location {

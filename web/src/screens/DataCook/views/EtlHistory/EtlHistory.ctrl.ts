...
import { DateTimeCell } from '@/shared/components/Common/DiTable/CustomCell';
import { DefaultPaging, Routers, Status } from '@/shared';
import { Inject } from 'typescript-ioc';
import { DataCookService, EtlJobInfo, EtlJobStatus, GetListEtlRequest } from '@core/DataCook';
...
export default class EtlHistoryCtrl extends Vue {
  @Inject

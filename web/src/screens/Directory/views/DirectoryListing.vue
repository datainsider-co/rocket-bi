...
import { CreateDashboardRequest, CreateDirectoryRequest, Directory, DirectoryId, DirectoryType } from '@core/domain';
...
import { ShareDirectoryLinkHandler } from '@/shared/components/Common/DiShareModal/LinkHandler/ShareDirectoryLinkHandler';

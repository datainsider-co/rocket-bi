<template>
  <StatusWidget class="position-relative" :status="status" :errorMessage="errorMessage">
    ...
    <CalculatedFieldModal
      ...
      @created="loadTableSchema(syncedModel.table, false)"
      @updated="loadTableSchema(syncedModel.table, false)"
    />
  </StatusWidget>
</template>
...
import { BoolColumn, ColumnType, DatabaseSchema, DIException, TableSchema } from '@core/domain';
...
import { DeleteFieldData } from '@/screens/ChartBuilder/ConfigBuilder/DatabaseListing/CalculatedFieldData';
...
export default class CalculatedFieldManagement extends Vue {
  ...
  private async loadTableSchema(tableSchema: TableSchema, force = true) {
    try {

...
import { DashboardId, DIException, Directory, DirectoryId, DirectoryPagingRequest, DirectoryType } from '@core/domain';
...
import PickFile from '@/screens/LakeHouse/Components/MoveFile/PickFile.vue';

...
// @ts-ignore
import TableItem from '@/screens/DataManagement/views/DataRelationship/components/TableItem.vue';
import LeaderLine from 'leader-line-new';
import difference from 'lodash/difference';
import xor from 'lodash/xor';
import { Log } from '@core/utils';
import { Column, DatabaseSchema, InlineSqlView, TableField, TableSchema, ViewField } from '@core/domain';
import { increaseDiv } from '@/screens/DataCook/components/ManageEtlOperator/constance';
...
import CurvedConnector from '@/screens/DataCook/components/DiagramPanel/CurvedConnector.vue';
import StatusWidget from '@/shared/components/StatusWidget.vue';
import { Status } from '@/shared';
import Konva from 'konva';
import TableActionContextMenu from '@/screens/DashboardDetail/components/Relationship/TableActionContextMenu.vue';
import ConnectionActionContextMenu from '@/screens/DashboardDetail/components/Relationship/ConnectionActionContextMenu.vue';

const productionConfig = {
  ...
  VUE_APP_CAAS_API_URL: 'http://localhost:8080',
  VUE_APP_BI_API_URL: 'http://localhost:8080',
  VUE_APP_SCHEMA_API_URL: 'http://localhost:8080',
  VUE_APP_DATA_COOK_API_URL: 'http://localhost:8080',
  VUE_APP_LAKE_API_URL: 'http://localhost:8080',
  VUE_APP_CDP_API_URL: 'http://localhost:8080',
  VUE_APP_BILLING_API_URL: 'https://license.rocket.bihttp://localhost:8080',
  ...
  VUE_APP_IS_DISABLE_INGESTION: true,

...
export class RedshiftSourceInfo implements DataSourceInfo {
  ...
  static fromJdbcSource(obj: JdbcSource): DataSourceInfo {
    ...
    const redshiftSourceInfo = new RedshiftSourceInfo(obj.id, obj.orgId, obj.displayName, host, port, databaseName, obj.username, obj.password, obj.lastModify);
    return redshiftSourceInfo;
  }

  static fromObject(obj: any): RedshiftSourceInfo {
    return new RedshiftSourceInfo(
      obj.id,

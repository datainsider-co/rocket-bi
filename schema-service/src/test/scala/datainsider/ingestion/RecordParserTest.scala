...
import datainsider.ingestion.misc.parser.ClickHouseDataParser
...
class RecordParserTest extends Test with BeforeAndAfterAll {
  ...
  test("Parse records") {
    ...
    val records = Seq(
      Seq(1, "2020-01-12 09:12:09", "Ho Chi Minh", "PT2000", 67),
      Seq(1, "2020-01-12 09:12:09", "Ho Chi Minh", "Yame", 5980),
      Seq(1, "2020-02-12 09:12:09", "Hanoi", "4Men", "9080")
    )

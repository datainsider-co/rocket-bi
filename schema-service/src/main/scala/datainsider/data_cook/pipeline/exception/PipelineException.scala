package datainsider.data_cook.pipeline.exception
...
case class UnsupportedJDBCWriterException(message: String, cause: Throwable = null) extends OperatorException(message, cause) {

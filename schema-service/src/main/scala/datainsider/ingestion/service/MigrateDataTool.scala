...
import datainsider.ingestion.domain.{DatabaseSchema, TableSchema, TableType}
import datainsider.ingestion.repository.{DDLExecutor, SchemaMetadataStorage}

import javax.inject.Inject
import scala.collection.mutable

class MigrateDataTool @Inject() (ddlExecutor: DDLExecutor, storage: SchemaMetadataStorage, client: JdbcClient) extends Logging {

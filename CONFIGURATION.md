...
- By default, SSDB server will run at port `8888`
...
The above example will create 2 accounts with the given information. Then, you can use these accounts to login to this
system.

...
trait HttpClient {
  ...
  def get[T: Manifest](endPoint: String, headers: Seq[(String, String)] = Seq.empty): T
...
class SimpleHttpClient(apiHost: String) extends HttpClient {
  override def get[T: Manifest](endPoint: String, headers: Seq[(String, String)] = Seq.empty): T = {

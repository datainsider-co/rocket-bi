...
import datainsider.jobscheduler.domain.source._
...
case class DataSourceFactoryImpl() extends DataSourceFactory {
  ...
  override def build(
    ...
    dataSourceType match {
      ...
      case DataSourceType.TikTokAdsSource =>
        buildTikTokAdsSource(orgId, id, creatorId, displayName, lastModify, config)

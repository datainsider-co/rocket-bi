...
import datainsider.jobscheduler.domain.request.{CreateDatasourceRequest, PaginationRequest, UpdateDataSourceRequest}
import datainsider.jobscheduler.domain.{AmazonS3Source, DataSource, DatabaseType, JdbcSource, MongoSource}
import datainsider.jobscheduler.domain.{DataSource, DatabaseType, JdbcSource, MongoSource, ShopifySource}
